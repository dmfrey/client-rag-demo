...
@Component
class DocumentPersistenceAdapter implements SaveDocumentPort, LoadDocumentByFilenamePort, LoadDocumentByIdPort,
        LoadDocumentBySourceAndExternalIdPort, LoadAllDocumentsPort, DeleteDocumentPort {
    ...
    @Override
    public Optional<Document> loadBySourceAndExternalId(String source, String externalId) {
        return repository.findBySourceAndExternalId(source, externalId).map(DocumentPersistenceAdapter::toDomain);
    }
