...
class ResolveDeltaLinkTasklet implements Tasklet {
    ...
    ResolveDeltaLinkTasklet(SyncStatePort syncStatePort, SharePointProperties properties) {
    ...
    public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) {
        ...
        // guidance for an expired deltaLink.
        String startLink = syncStatePort.loadDeltaLink(properties.driveId())
                .orElseGet(() -> baseDeltaLink(properties.driveId()));
    ...
    private static String baseDeltaLink(String driveId) {
        return "https://graph.microsoft.com/v1.0/drives/" + driveId + "/root/delta";
    }
}
